...
def main():
    ...
    if page == "Home":
        ...
        st.write("This app allows you to predict car prices based on various features. You can filter the dataset and make predictions.")
        ...
        st.title("About")
        st.write("This app was developed to predict car prices using machine learning. The app uses a regression model to estimate the prices based on various features.")
...
input_background_color = "#87CEFA"
result_background_color = "#7FFFD4"
sidebar_background_color = "#87CEFA"
filter_background_color = "#87CEFA"
